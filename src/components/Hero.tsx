...
export default function Hero() {
    ...
    return (
        <section className="relative w-full h-[1080px] bg-white overflow-hidden font-roboto selection:bg-orange-200">
            {/* 1. Left Image Panel (Clipped by Arc) */}
            <div
                className="absolute top-0 left-0 z-10 w-full h-full"
                style={{
                    // Use clip-path to create the exact curve
                    // Radius: 1250 (Matches HeroOverlay ring)
                    // Center: -100px 540px
                    clipPath: 'circle(1250px at -100px 540px)',
                }}
            >
            ...
            {/* 2. SVG Overlay (Arc + Text + Slides) */}
            <HeroOverlay activeIndex={currentKangaroo} />

            {/* 3. Kangaroo Mascot (Bottom Right) */}
            ...
            {/* 4. Decorative Floating Boxes (Optional - keep existing simple ones) */}
